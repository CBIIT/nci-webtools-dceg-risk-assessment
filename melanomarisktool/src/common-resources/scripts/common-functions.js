...
// store image and reference it from now on
var personImg;
var img = new Image();
...
img.onload = function (){
    ...
    personImg.width = 25;
    personImg.height = 76;
//        personImg.width = this.width / 9.5;
//        personImg.height = this.height / 7.8;
...
function createMask(maskImg, canvasContext) {
    for (var i = 0; i < 20; i++) {
        for (var j = 0; j < 5; j++) {
//            canvasContext.drawImage(maskImg, canvasContext.canvas.width * i, canvasContext.canvas.height * j, maskImg.width, maskImg.height);
