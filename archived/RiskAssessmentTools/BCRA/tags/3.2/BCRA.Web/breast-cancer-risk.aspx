<%@ Page MasterPageFile="BCRA.master" Language="C#" Title="Breast Cancer Risk Factors - BCRAT" %>
...
<asp:Content ContentPlaceHolderID="cphNav" ID="cntNav" runat="server">
    <table width="194" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            ...
            <td valign="middle">
                <a href="breast-cancer-risk.aspx" class="current">Breast Cancer Risk Factors</a>
            </td>
            <td valign="top">
                &nbsp;
            </td>
...
<asp:Content ContentPlaceHolderID="cphMain" ID="cntMain" runat="server">
    ...
    <div class="maincontentbox">
        <div class="maincontentboxtitle">
            <ul>
                <li class="left title">Breast Cancer Risk Factors</li><li class="title">&nbsp</li>
        ...
        <div class="maincontentboxtext">
            <p>
                ...
                Risk factors for breast cancer include the following:</p>
            <ul class="red-arrow">
                <li>age</li>
                <li>age at the start of <a class="grey-text" href="def-menst.html" onclick="popUp('def-menst.html');return false;">
                    menstruation</a></li>
                <li>age at first live birth</li>
                <li>number of first-degree relatives (mother, sisters, daughters) with breast cancer</li>
                <li>number of previous breast <a class="grey-text" href="def-biopsy.html" onclick="popUp('def-biopsy.html');return false;">
                    biopsies</a> (whether positive or negative)</li>
                <li>at least one breast biopsy with <a class="grey-text" href="def-ah.html" onclick="popUp('def-ah.html');return false;">
                    atypical hyperplasia</a></li>
            </ul>
            <p>
            ...
            <p>
                ...
                predispositions for breast cancer, such as inheriting a mutation in either the <a
                    class="grey-text" href="def-brca1.html" onclick="popUp('def-brca1.html');return false;">
                    <em>BRCA1</em></a> or <a class="grey-text" href="def-brca2.html" onclick="popUp('def-brca2.html');return false;">
                        <em>BRCA2</em></a> gene, are not taken into account in risk estimates with
                ...
                mutation in <a class="grey-text" href="def-brca1.html" onclick="popUp('def-brca1.html');return false;">
                    <em>BRCA1</em></a> or <a class="grey-text" href="def-brca2.html" onclick="popUp('def-brca2.html');return false;">
                        <em>BRCA2</em></a>. See <a href="about-tool.aspx">"About the Tool"</a> for more information.
            </p>
            <p>
                ...
                the statistical model, called the <a href="about-tool.aspx#gail">Gail model</a>,
                upon which the Breast Cancer Risk Assessment Tool is based. Nonetheless, the current
                model estimates breast cancer risk accurately on average.</p>
            <p>
                For more information on breast cancer risk, please visit <a href="http://www.cancer.gov/cancertopics/prevention-genetics-causes/breast">
                    Breast Cancer: Prevention, Genetics, Causes</a>.</p>
        </div>
    </div>
</asp:Content>
