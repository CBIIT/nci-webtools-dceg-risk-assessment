<%@ Page MasterPageFile="BCRA.master" Language="C#" Title="Download Source Code - BCRAT" %>
...
<asp:Content ContentPlaceHolderID="cphMain" ID="cntMain" runat="server">
    ...
    <div class="maincontentbox">
        ...
        <div class="maincontentboxtext">
            <h2>
                Download Source Code for the Breast Cancer Risk<br />
            ...
            <p>
                <strong>What You&rsquo;ll Download</strong><br />
                A ZIP file (46 KB) containing the source code and <a href="documentation.aspx">documentation</a>
                for the breast cancer risk calculation engine. The code is available as a C# class
                library.</p>
            <p>
                By downloading, you accept our <a href="code-conditions.aspx">Terms &amp; Conditions</a>.</p>
            <p>
                <a href="files/BCRA_Source_Code.zip">
                    <img src="Images/btn-accept.gif" alt="Accept &amp; Download" width="139" height="25"
                        border="0" /></a></p>
        </div>
    </div>
</asp:Content>
