<%@ Page MasterPageFile="BCRA.master" Language="C#" Title="Documentation - BCRAT" %>
                ...
                <table width="194" cellspacing="0" cellpadding="0" border="0" class="subnav">
                    <tr onmouseover="this.bgColor='#ffffff'" onmouseout="this.bgColor='#F2F5F8'">
                        ...
                        <td valign="middle" width="152">
                            <span class="subnavrow"><a href="documentation.aspx" class="current">Documentation</a></span>
                        </td>
                        <td valign="top" width="7">
                            &nbsp;
                        </td>
                    ...
                    <tr onmouseover="this.bgColor='#ffffff'" onmouseout="this.bgColor='#F2F5F8'">
                        ...
                        <td valign="middle" width="152">
                            <span class="subnavrow"><a href="code-conditions.aspx">Terms &amp; Conditions</a></span>
                        </td>
                        <td valign="top" width="7">
                            &nbsp;
                        </td>
    ...
    <div class="maincontentbox">
        ...
        <div class="maincontentboxtext">
            <h2>
                Documentation</h2>
            <h3>
                Breast Cancer Risk Assessment Tool, Source Code download Read Me File</h3>
            <p>
                The Breast Cancer Risk Assessment Tool may be updated periodically as new data or
                research becomes available. The algorithm was last updated in May 2011. The current
                software version is 3.0</p>
            <p>
                Download the zip file and unpack it an appropriate directory. The zip file will
                contain the following two files:</p>
            <ul class="red-arrow">
                <li>This readme file.</li>
                <li>The NCI.DCEG.BCRA.zip file which contains the source code.</li>
            </ul>
            <p>
                Unzip the NCI.DCEG.BCRA.zip file into an appropriate directory, you should see the<br />
                following files:</p>
            <ul class="red-arrow">
                <li>NCI.DCEG.BCRA.sln: The Visual Studio 2005 solution file. You can double click and
                    run this solution in order to test the breast cancer risk assessment calculation
                    engine.</li>
                <li>NCI.DCEG.BCRA.ConsoleSample: A sample console application demonstrating the usage
                    of the code.</li>
                <li>NCI.DCEG.BCRA: A class library project that contains the breast cancer risk assessment
                    calculation engine.</li>
            </ul>
            <p>
                <a href="download-source-code.aspx"></a>
            </p>
        </div>
    </div>
</asp:Content>
