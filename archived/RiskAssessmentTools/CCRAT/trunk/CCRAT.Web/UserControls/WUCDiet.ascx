...
<div id="qdivDemo"  class="question">
	<div class="qtext">
		...
		In the <span class="bold">past 30 days</span>, about how many
            ...
            ControlToValidate="ddlVeggie" Display="Dynamic" ErrorMessage="Please select vegetable servings per week" 
...
<asp:ValidationSummary ID="VgDemoSummaryRequiredFields" runat="server" ShowMessageBox="True" ValidationGroup="vgDiet" ShowSummary="False" />
