...
<asp:Content ContentPlaceHolderID="cphMainContent" ID="cMainContent" runat="server">
    <asp:PlaceHolder ID="phToolNotes" runat="server">
        <p style="margin-bottom: 12px;"><strong>Update November 2014:</strong> NCI corrected risk estimates for men corresponding to answers "polyps unknown" (page 3 of 7) and for men and women corresponding to answers “medications that do not contain aspirin unknown" (page 4 of 7).</p>
        ...
        <ul class="red-arrow">
            ...
            <li>This tool cannot accurately estimate risk of colorectal cancer for people who have the following problems:
                <ul>
                    ...
                    <li>Hereditary Nonpolyposis Colorectal Cancer (HNPCC), also known as Lynch Syndrome</li>
