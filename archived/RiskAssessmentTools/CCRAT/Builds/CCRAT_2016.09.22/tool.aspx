            ...
            <asp:View ID="vDemo" runat="server">	
                 <div class="contentwrapper" id="divDemo">
                    ...
                    <div class="lowerbutton">
                        <asp:ImageButton ID="imgBtnCancel" runat="server" AlternateText="Cancel" OnClick="btnCancel_click" OnClientClick="window.close()" ImageUrl="~/images/cancel.png" border="0" />
                        &nbsp;
