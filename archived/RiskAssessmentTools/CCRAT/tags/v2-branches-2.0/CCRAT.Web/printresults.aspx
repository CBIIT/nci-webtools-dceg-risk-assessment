...
<body>
    ...
    <div id="center-page">
        <div id="divncibanner">
            <img src="images/nci-banner.gif" alt="nci-banner" width="759" height="39" border="0"
                usemap="#ncibanner" />
        </div>
    <div style="text-align:center;height:30px;padding-top:10px;background-color:#DAD9D4"><span style=" font-family:'Arial'; color:#000000; font-size:16px;"><b>Colorectal Cancer Risk Assessment Tool</b></span></div>
        <div id="main">
            <div id="left">
                <div id="padding" class="padding">
                    Your <b>5 Years risk</b> is estimated to be <b>between
                        <%=InputLow5 %>% and
                        <%=InputHigh5 %>%</b>.
                <br /><br />
            ...
            <div id="middle">
                <div id="Div1" class="padding">
                    ...
                    Your <b>10 Years risk</b> is estimated to be <b>between
                        <%=InputLow10 %>% and
                        <%=InputHigh10 %>%</b>.
                <br /><br />
            ...
            <div id="right">
                <div id="Div2" class="padding">
                    ...
                    Your <b>lifetime risk</b> is estimated to be <b>between
                        <%=InputLowlt %>% and
                        <%=InputHighlt %>%.</b>
                <br /><br />
                Estimates are not exact. Your risk for developing colorectal cancer during your<br />
