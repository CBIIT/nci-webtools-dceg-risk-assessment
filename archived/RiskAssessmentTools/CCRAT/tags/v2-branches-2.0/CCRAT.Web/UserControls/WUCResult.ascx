<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WUCResult.ascx.cs" Inherits="CCRAT.Web.UserControls.WUCResult" %>
				...
				<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="320" height="230" align="middle" id="final_dyn_v3.swf" >
					<param name="allowscriptaccess" value="samedomain" />
					<param name="movie" value="/Flash/final_dyn_v3.swf" />
					<param name="quality" value="high" />
			                <param name="wmode" value="transparent" />
					<param name="bgcolor" value="#ffffff" />
					<param NAME=FlashVars VALUE="input_high=<%=InputHigh %>&input_low=<%=InputLow %>&input_avg=<%=InputAvg %>" />
					<embed src="/Flash/final_dyn_v3.swf" 
						quality="high" bgcolor="#ffffff" 
						width="290" height="230" 
						name="final_dyn_v3.swf" 
			...
			<a href="willget.aspx?Y=<%=Years %>&IL=<%=InputLow %>&IH=<%=InputHigh %>"><img src="/images/williget.png" border="0" alt="Does this mean I will get colorectal cancer" /></a>
