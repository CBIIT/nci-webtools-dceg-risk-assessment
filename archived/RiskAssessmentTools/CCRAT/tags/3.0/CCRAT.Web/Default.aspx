    ...
    <asp:PlaceHolder ID="phToolNotes" runat="server">
        ...
        <ul class="red-arrow">
            ...
            <li>This tool can estimate the risk of colorectal cancer for men and women who are:
                <ul>
                    <li>Between the ages of 50 and 85</li>
            ...
            <li>This Web site can help you learn more about cancer risk, including colorectal cancer risk: <a href="http://understandingrisk.cancer.gov">Cancer Risk: Understanding the Puzzle</a> from NCI</li>
