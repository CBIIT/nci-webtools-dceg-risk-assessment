 ...
 <div class="pagewrapper">
		    ...
		    <div class="graphcontainer">
			    <div class="graph_howhigh" style="margin-left: 12px;">
			        <div id="tabs" >
                        <ul>
                            <li style="text-align:center"><a href="#tabs1" id="5yeartab" ><span class="titlebold">5 year risk</span><br />Average:<%=Input5yearAvg%>%<br />You: <%=Input5yearAbs %>%</a></li>                            
                            <li style="text-align:center"><a href="#tabs2" id="10yeartab"><span class="titlebold">10 year risk</span><br />Average:<%=Input10yearAvg%>%<br />You: <%=Input10yearAbs %>%</a></li>
                            <li style="text-align:center"><a href="#tabs3" class="defaulttab" id="Lifetab"><span class="titlebold">Lifetime risk</span><br />Average:<%=InputLTyearAvg%>%<br />You: <% =InputLifeAbs%>%</a></li>
                        </ul>
