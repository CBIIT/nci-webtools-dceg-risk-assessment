 ...
 <div class="pagewrapper">
		    ...
		    <div class="graphcontainer">
			    <div class="graph_howhigh" style="margin-left: 12px;">
			        <div id="tabs" >
                        <ul>
                            <li style="text-align:center"><a href="#tabs1"><span class="titlebold">5 year risk</span><Br />Average:<%=Input5yearAvg%>%<br />You: <%=Input5yearLow%>% - <%=Input5yearHigh%>%</li>
                            <li style="text-align:center"><a href="#tabs2"><span class="titlebold">10 year risk</span><Br />Average:<%=Input10yearAvg%>%<br />You: <%=Input10yearLow%>% - <%=Input10yearHigh%>%</li>
                            <li style="text-align:center"><a href="#tabs3" class="defaulttab"><span class="titlebold">Lifetime risk</span><Br />Average:<%=InputLTyearAvg%>%<br />You: <%=InputLTyearLow%>% - <%=InputLTyearHigh%>%</li>
                        </ul>
...
Studies have shown that hormone replacement therapy (HRT) that includes both estrogen and progesterone lowers the risk of colorectal cancer in postmenopausal women. HRT with estrogen alone does not lower the risk.
		...
		<div class="blankspace" style="height: 12px;"> </div>
			...
			<center>
			<a href="javascript:toggle('definitionEdit');switch_tabs($('#defaulttab'));" id="definition_link"><img src="/images/editpersonalbold.png" border=0 /></a>
...
<div id="definitionEdit" style="display: none;" class="lb_containerResult"><!-- lightbox -->
    <div class="popup_container_result"><!-- centered box -->
        ...
        <div id="Div2" style="text-align: right; padding-right: 10px;">
	            <a href="#definition_link" onclick="toggle('definitionEdit',event); 
