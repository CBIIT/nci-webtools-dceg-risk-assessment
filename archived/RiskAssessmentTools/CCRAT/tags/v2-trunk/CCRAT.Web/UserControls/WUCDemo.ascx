...
<div id="qdivHispanic" class="question">
	<div class="qtext">
        ...
        <asp:RequiredFieldValidator ID="rfvHispanic" runat="server" 
            ControlToValidate="rblhispanic" Display="Dynamic" ErrorMessage="*" 
...
<div id="qdiv3" class="question">
    <div class="qtext">
        ...
        <asp:RangeValidator ID="rvAge" runat="server" ControlToValidate="ddlCurrentAge" 
            Display="Dynamic" ErrorMessage="Required" MaximumValue="85" MinimumValue="50" 
...
<div id="qdiv4" class="question">
    <div class="qtext">
        ...
        <asp:RequiredFieldValidator ID="rfvSex" runat="server" 
            ControlToValidate="rblSex" Display="Dynamic" ErrorMessage="*" 
            ValidationGroup="vgDemo">Required</asp:RequiredFieldValidator>
        </span>
        <div class="qbreak"></div>
...
<div id="qdiv5" class="question">
    <div class="qtext">
        ...
        <asp:RequiredFieldValidator ID="rfvHeight" runat="server" 
            ControlToValidate="txtFeet" Display="Dynamic" ErrorMessage="*" 
            ValidationGroup="vgDemo">Required</asp:RequiredFieldValidator>
        </span>
        <div class="qbreak">
        </div>
        <asp:TextBox ID="txtFeet" runat="server" class="heighweight" onkeyup="onlyDigit2(this)"
            onkeypress="onlyDigit2(this)"></asp:TextBox>
        feet
        <asp:TextBox ID="txtInch" runat="server" class="heighweight" onkeyup="onlyDigit2(this)"
            onkeypress="onlyDigit2(this)"></asp:TextBox>
        inches
...
<div id="qdiv6" class="question">
    <div class="qtext">
        ...
        <asp:TextBox ID="txtWeight" runat="server" class="heighweight" onkeyup="onlyDigit2(this)"
            onkeypress="onlyDigit2(this)"></asp:TextBox>
        lbs
        <div class="blankspace">
        </div>
