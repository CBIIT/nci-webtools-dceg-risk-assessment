		...
		<div id="qdivWoman"   class="question">
			<div class="qtext">
					...
					Do you still have periods?
	                                        [<a href="javascript:toggle('defStillHavePeriods');" id="more_" class="def_link_more" title="More about ">More</a>]
...
When did you have your last period?
	                                        [<a href="javascript:toggle('defLastCycle');" id="more_" class="def_link_more" title="More about ">More</a>]
