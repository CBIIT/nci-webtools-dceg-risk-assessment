		...
		<div id="qdiv"  class="question">
			<div class="qtextindent">
                ...
                <asp:DropDownList ID="ddlMod" runat="server">
                    ...
                    <asp:ListItem Text="Up to 1 hour per week" Value="2"></asp:ListItem>
                    <asp:ListItem Text="Between 1-2 hours per week" Value="3"></asp:ListItem>
                    <asp:ListItem Text="Between 2-3 hours per week" Value="4"></asp:ListItem>
                    <asp:ListItem Text="Between 3-4 hours per week" Value="5"></asp:ListItem>
                    <asp:ListItem Text="More than 4 hours per week" Value="6"></asp:ListItem>
                </asp:DropDownList>					
		        <div class="blankspace"> </div>
			</div>
		</div>
