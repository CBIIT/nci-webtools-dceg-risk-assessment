		...
		<div id="qdiv"  class="question">
			<div class="qtext">
					...
					<asp:RangeValidator ID="rfvModerateMonth" runat="server" 
                        ControlToValidate="ddlModerateActivities" Display="Dynamic" ErrorMessage="Please select moderate physical activity over the past 12 months" 
		...
		<div id="qdivVigorousActivities"  class="question">
			<div class="qtext">
				...
				<asp:RangeValidator ID="rfvVigourMonth" runat="server" 
                    ControlToValidate="ddlVigorousActivities" Display="Dynamic" ErrorMessage="Please select vigorous physical activity over past 12 months" 
...
<asp:ValidationSummary ID="VgDemoSummaryRequiredFields" runat="server" ShowMessageBox="True" ValidationGroup="vgActivity" ShowSummary="False" />
