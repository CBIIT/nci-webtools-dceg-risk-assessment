...
namespace CCRAT.Web
{
    ...
    public partial class Result : System.Web.UI.Page
    {
        ...
        // non-percentile raw risk values
        public string Input5yearRisk { get; set; }
        public string Input10yearRisk { get; set; }
        public string InputLifeRisk { get; set; }
        ...
        private void RenderTabs()
        {
            if (Session[CCRATString.CCRAT] != null)
            {
                ...
                this.Input5yearRisk = risks.FiveYearAbsRisk.ToString();
               ...
               this.Input10yearRisk = risks.TenYearAbsRisk.ToString();
               //this.Input10yearAvg = this.WUCResult2.InputAvg = ((Math.Round(risks.AbsRisk10U * 100, 1) + Math.Round(risks.AbsRisk10L * 100, 1)) / 2).ToString();
                ...
                this.InputLifeRisk = risks.LifetimeAbsRisk.ToString();
