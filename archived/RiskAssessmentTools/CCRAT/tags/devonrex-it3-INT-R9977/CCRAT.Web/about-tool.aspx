...
<asp:Content ContentPlaceHolderID="cphDateVer" ID="cDateVer" runat="server"><p class="version">Last modified date: 11/25/2014</p></asp:Content>
...
<div class="maincontentboxtext-paddedText">
    ...
    <div class="questionExplanations">
        ...
        <CCRAT:AboutExplanation ID="AboutExplanation9" runat="server">
            ...
            <Explanation>
                Polyps are growths on the inner wall of the colon or rectum. They are common in people over age 50. Most polyps are not cancer, but some can become cancer. Finding and removing polyps may reduce the risk of colorectal cancer.  [Risk estimates for men for "polyps unknown" corrected on 10/7/2014.]
            </Explanation>
        </CCRAT:AboutExplanation>
