...
[<a href="javascript:toggle('more_smoke');" id="more_lk_smoke" class="def_link_more" title="More about ">More</a>]
            <asp:RequiredFieldValidator ID="rfvSmoke" runat="server" 
                ControlToValidate="rblSmoked" Display="Dynamic" ErrorMessage="Please select in your entire lifetime, altogether, have you smoked 100 or more cigarettes" 
        ...
        <div id="qdivagestarted"   class="question">
            <div class="qtextindent" >
                ...
                <asp:CustomValidator ID="rfvSmokeStart" runat="server"  OnServerValidate="ValidateControlSmokeStart"  
                    ControlToValidate="ddlHowOld" Display="Dynamic" ErrorMessage="Please select how old were you when you started smoking cigarettes" 
...
<asp:ValidationSummary ID="VgDemoSummaryRequiredFields" runat="server" ShowMessageBox="True" ValidationGroup="vgMisc" ShowSummary="False" />
