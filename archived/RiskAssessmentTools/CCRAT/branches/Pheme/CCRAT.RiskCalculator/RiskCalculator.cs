...
namespace CCRAT.RiskCalculator
{
    ...
    {
        /// <summary>
        /// Calculates the risk for men and return the absolute risk object containing all the properties required to display results
        /// </summary>
        ...
        /// <returns>Absolute risk object</returns>
        ...
        /// <summary>
        /// Calculates the risk for Women and return the absolute risk object containing all the properties required to display results
        /// </summary>
        /// <param name="race"></param>
        /// <param name="currentAge"></param>
        /// <param name="numrel"></param>
        ...
        /// <param name="hrsExcrise"></param>
        /// <param name="bmi"></param>
        /// <returns>AbsoluteRisks object</returns>
